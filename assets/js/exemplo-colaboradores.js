...
console.log(colaboradorNome.sort());

//criar uma nova lista com os nome completo dos colaboradores
//tenho una lista de objetos, gerar uma lista de string
let colaboradoresNomeCompletos = colaboradores.map(colaborador => {
    return { "nome": colaborador.nome + " " + colaborador.sobrenome };
}
);
//criar uma nova lista com o nome e salario bruto dos colaboradores7
...
// descobrir colaboradores desconto abaixo de 100 reais
